        ...
        <div className={styles.right_container}>
          ...
          <div className={styles.right_main}>
            <div className={styles.status}>
              Status: <span className={styles.status_value}>Not Delivered</span>
            </div>
              ...
              <div className={styles.row}>
                <div className={styles.col_1}>
                  <div className={styles.img_container}>
                    <img src='/images/68-105-274-V01.jpg' alt='' className='' />
                  </div>
                </div>
          ...
          <div className={styles.right_bottom}>
            <div className={styles.row_bottom}>
              <div className={styles.col}>
                ...
                <div className={styles.user_zip}>
                  City-Zip
                  <span className={styles.content}>5800</span>
                </div>
                <div className={styles.user_division}>
                  Division, Country:
              ...
              <div className={styles.col}>
                ...
                <div className={row_summary}>
                  ...
                  <div className={styles.col_summary}>
                    <div className={styles.summary_title}>Delivery Charge:</div>
                    <div className={styles.summary_value}>50000</div>
                  </div>
                  <div className={styles.col_summary}>
